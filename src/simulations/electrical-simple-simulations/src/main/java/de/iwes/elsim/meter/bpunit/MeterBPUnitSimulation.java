 ...
 */
public class MeterBPUnitSimulation extends SimulationBase<MeterBPUnitSimConfigPattern, MeterBPUnitPattern> {
	...
	public MeterBPUnitSimulation(ApplicationManager am) {
		super(am, MeterBPUnitPattern.class, true, MeterBPUnitSimConfigPattern.class);
		elCons = new ResourcePatternManagement<ElConPattern, Object>(am, ElConPattern.class, this);
	}	

	@Override
	public String getProviderId() {
		return "Building unit meter simulation";
	}
	
	@Override
	public Class<? extends Resource> getSimulatedType() {
		return BuildingPropertyUnit.class;
	}
	
	@Override
	public void buildConfigurations(MeterBPUnitPattern pattern, List<SimulationConfiguration> cfgs, MeterBPUnitSimConfigPattern simPattern) {
	...
	@Override
	public void buildQuantities(MeterBPUnitPattern pattern, List<SimulatedQuantity> quantities, MeterBPUnitSimConfigPattern simPattern) {
		// Add here configuration values that can be edited by the user, see example below
	...
	public String getDescription() {
		return "Simulated meter for a building property unit collecting power from electricity connections";
	}
	 ...
	 */
	@Override
	public void simTimerElapsed(MeterBPUnitPattern targetPattern, MeterBPUnitSimConfigPattern configPattern, Timer t, long timeStep) {
	...
	@Override
	protected void initSimulation(MeterBPUnitPattern targetPattern, MeterBPUnitSimConfigPattern configPattern) {
	...
	@Override
	protected void removeSimulation(MeterBPUnitPattern targetPattern, MeterBPUnitSimConfigPattern configPattern) {
