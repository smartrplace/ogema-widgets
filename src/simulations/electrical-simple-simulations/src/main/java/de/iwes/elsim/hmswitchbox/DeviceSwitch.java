...
public class DeviceSwitch implements SimulationComplexConfiguration {
	...
	public DeviceSwitch(BooleanResource stateFeedback) {
		this.stateFeedback = stateFeedback;
	}

	@Override
	public String getId() {
		return "Set device on/off";
	}

	@Override
	public String getDescription() {
		return "Set device electrical switch position";
	}
