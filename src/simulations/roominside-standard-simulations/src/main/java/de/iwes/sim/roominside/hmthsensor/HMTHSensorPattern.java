...
import de.iwes.tools.standard.pattern.sensors.GenericRoomSensorPattern;

public class HMTHSensorPattern extends GenericRoomSensorPattern { 
	 ...
	 */
	public HMTHSensorPattern(Resource device) {
		super(device);
	}
