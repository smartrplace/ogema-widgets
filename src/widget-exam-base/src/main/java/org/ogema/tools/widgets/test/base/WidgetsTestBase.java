...
public abstract class WidgetsTestBase extends LatestVersionsTestBase {
	...
	protected final String modelsProposedVersion = "2.1.2";
	@Inject
	...
	public WidgetsTestBase(boolean includeTestBundle) {
...
//									 CoreOptions.mavenBundle("org.ogema.model", "fhg-proposed", modelsProposedVersion), // dependency of util-extended
									 CoreOptions.mavenBundle("org.ogema.model", "widget-models-proposed", widgetsVersion), // dependency of util-extended
									 CoreOptions.mavenBundle("org.ogema.widgets", "util-extended", widgetsVersion),
...
//									 CoreOptions.mavenBundle("org.ogema.widgets", "widget-collection-util", widgetsVersion),
...
//									 CoreOptions.mavenBundle().groupId("org.apache.httpcomponents").artifactId("httpasyncclient-osgi").versionAsInProject(),
									 ...
									 CoreOptions.mavenBundle("joda-time", "joda-time", "2.9.3")); // FIXME still required?
	}
