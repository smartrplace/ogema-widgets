...
public class ResourcePlotNvd3Options extends PlotFlotOptions {
	
	private final ResourceDataNvd3 resourceData = new ResourceDataNvd3();

	/***** Constructor ****/
	
	public ResourcePlotNvd3Options(ResourcePlotNvd3 plot) {
		super(plot);
	}
	...
	public ResourceDataNvd3 getResourceData() {
		return resourceData;
	}
