...
public class SchedulePlotlyjsOptions extends PlotlyjsOptions {
	
	private final ScheduleDataPlotlyjs scheduleData;
	
	/***** Constructor ****/
	
	public SchedulePlotlyjsOptions(SchedulePlotlyjs plot) {
		super(plot);
		scheduleData = new ScheduleDataPlotlyjs(plot.maxValues, plot.bufferWindow);
	}
	...
	public JSONObject retrieveGETData(OgemaHttpRequest req) {
		Map<String,PlotlyjsDataSet> backup = new LinkedHashMap<String, PlotlyjsDataSet>(dataSets);
	...
	public ScheduleDataPlotlyjs getScheduleData() {
		return scheduleData;
	}
