...
public class CorrelationProvider implements EvaluationProvider, EvaluationListener {
	...
	public String label(OgemaLocale locale) {
		return "Correlation provider";
	}

	@Override
	public String description(OgemaLocale locale) {
		return "Determines the correlation between time series";
	}
	...
	public EvaluationInstance newEvaluation(List<EvaluationInput> input, List<ResultType> requestedResults,
		...
		final CorrelationEvaluation instance = new CorrelationEvaluation(input, requestedResults, configurations, this, 
	...
	private final List<ResultType> types = Collections.unmodifiableList(Arrays.asList(
			BasicEvaluationProvider.AVERAGE, STD_DEV, CORRELATION_TYPE
	));
	...
	private static final class CorrelationInput implements RequiredInputData {
		
		private final String id;
		
		public CorrelationInput(String id) {
			this.id = id;
		}
	...
	private static final List<RequiredInputData> inputList = Collections.<RequiredInputData> unmodifiableList(Arrays.asList(
			new CorrelationInput("generic_a"), new CorrelationInput("generic_b")
	));
	
	public final static ResultType STD_DEV = new ResultType() {
		...
		@Override
		public String description(OgemaLocale locale) {
			return "Calculate the standard deviation of a time series";
		}
	...
	public final static ResultType CORRELATION_TYPE = new ResultType() {
		...
		@Override
		public String description(OgemaLocale locale) {
			return "Determines the correlation between two time series (uncorrected)";
		}

		@Override
		public ResultStructure resultStructure() {
			return ResultStructure.COMBINED;
		}
		...
		@Override
		public String id() {
			return "correlation_uncorrected";
		}
