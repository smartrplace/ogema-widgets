...
public class GaRoBaseMultiResult extends GaRoMultiResult {
	...
	public GaRoBaseMultiResult(List<MultiEvaluationInputGeneric> inputData, long start, long end, Collection<ConfigurationInstance> configurations) {
	...
	public String getSummary() {
		return "GaRoWinResult: start:"+TimeUtils.getDateAndTimeString(startTime)+
	        	...
	        	" Found total " + overallResults.gwCountWithData+ " of "+ overallResults.gwCount + " gateways with data of quality >=" + GaRoBaseMultiEvaluation.MINIMUM_QUALITY_REQUIRED;
	}
}
