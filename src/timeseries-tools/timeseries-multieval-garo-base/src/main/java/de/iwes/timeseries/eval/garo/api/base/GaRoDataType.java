...
public class GaRoDataType implements GaRoDataTypeI {
	...
	public static final GaRoDataType ValveErrorState = new GaRoDataType("ValveErrorState", 
			FloatResource.class);
	public static final GaRoDataType ValveDecalcEff = new GaRoDataType("ValveDecalcEff", 
			FloatResource.class);
	...
	public static final GaRoDataType GlobalButtonLockCt = new GaRoDataType("GlobalButtonLockCt", 
			BooleanResource.class);
	public static final GaRoDataType GlobalButtonLockFb = new GaRoDataType("GlobalButtonLockFb", 
			BooleanResource.class);
