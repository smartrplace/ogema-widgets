...
public interface GaRoPreEvaluationProvider
		extends PreEvaluationProvider {

	RoomData getRoomData(long startTime, String gwId, String roomId);
	List<RoomData> getGatewayData(long startTime, String gwId);
	RoomData getOverallGatewayRoom(long startTime, String gwId);
}
