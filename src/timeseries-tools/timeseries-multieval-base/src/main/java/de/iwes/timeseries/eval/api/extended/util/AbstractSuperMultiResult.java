...
/**Contains the results for all evaluation intervals of a multi-evaluation*/
public class AbstractSuperMultiResult<T extends MultiResult> extends AbstractMultiResult {
	public AbstractSuperMultiResult(List<MultiEvaluationInputGeneric> inputData, long startTime, Collection<ConfigurationInstance> configurations) {
