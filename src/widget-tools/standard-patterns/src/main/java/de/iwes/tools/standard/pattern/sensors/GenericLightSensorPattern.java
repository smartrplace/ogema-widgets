 ...
 */
public class GenericLightSensorPattern extends ResourcePattern<LightSensor> {
	...
	public final BrightnessResource brightness = model.reading();

	/**
	 * Constructor for the access pattern. This constructor is invoked by the framework.
	 */
	public GenericLightSensorPattern(Resource device) {
		super(device);
	}
