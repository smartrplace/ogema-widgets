...
@Component(
		...
		property= {
				...
				LazyWidgetPage.RELATIVE_URL + "=plotlyjs.html",
				LazyWidgetPage.START_PAGE + "=false",
				LazyWidgetPage.MENU_ENTRY + "=Plotly.js test page"
		}
)
public class PlotlyTestPage implements LazyWidgetPage {
	...
	private static class PlotlyTestPageInit {
		...
		private final SchedulePlotlyjs schedulePlot;
		...
		public PlotlyTestPageInit(final WidgetPage<?> page, final ApplicationManager appMan) {
			...
			header.setDefaultText("Plotly.js test page");
